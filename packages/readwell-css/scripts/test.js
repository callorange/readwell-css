...
console.log('Running readwell-css automated build and integrity test...');
...
console.log('\n\x1b[32m✔ All readwell-css automated build & integrity tests passed successfully!\x1b[0m');
